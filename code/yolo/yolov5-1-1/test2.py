...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        for si, pred in enumerate(output):
            ...
            save_img_path = save_dir + '/' + os.path.basename(img_path)
            ...
            if save_txt:
                ...
                for *xyxy, conf, cls in x:
                    ...
                    plot_one_box(xyxy, img0, label=num, color=colors[int(cls)], line_thickness=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-dir', type=str, default='inference/5s', help='output folder')  # output folder
