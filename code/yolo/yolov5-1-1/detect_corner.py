...
if __name__ == '__main__':
    ...
    source = "F:/ZYY/chess/images/test3/check/labs/hist/"
    out = "F:/ZYY/chess/images/test3/txt4corner/out-corner/"

    parser.add_argument('--weights', nargs='+', type=str, default='runs/pt/weights/corner.pt', help='model.pt path(s)')
