...
def detect(save_img=False):
    src_txt_dir = "F:/ZYY/chess/images/tencent/check/txt-1-1/"
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        label_bnd = num + ' ' + str(int(bnd[0])) + ' ' + str(int(bnd[1])) + ' ' + str(
...
if __name__ == '__main__':
    ...
    source = "F:/ZYY/chess/images/tencent/result/"
    out = "F:/ZYY\chess/images/tencent/check/out-1-1/"
    # source = "F:/ZYY/chess/images/test2/tmp/images/"
    # out = "F:/ZYY/chess/images/test2/tmp/out-1-1/"

    parser.add_argument('--weights', nargs='+', type=str, default='runs/pt/weights/1-1-600.pt', help='model.pt path(s)')
