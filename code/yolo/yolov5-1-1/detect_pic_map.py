...
import test_my  # import test.py to get mAP after each epoch
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/exp11/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='inference/images/images_1189-1475', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='inference/output/images_1189-1475-out-exp11', help='output folder')  # output folder
