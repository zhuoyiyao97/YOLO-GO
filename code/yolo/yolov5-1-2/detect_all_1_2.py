...
def detect(save_img=False):
    src_txt_dir = "F:/ZYY/chess/images/test3/check/labs/txt-1-2/"
    # src_txt_dir = "F:/ZYY/chess/images/test2/tmp/txt-1-2/"
                    ...
                    #         num = '2'
                        ...
                        if label == string:
                            ...
                            label_bnd = label[0] + ' ' + str(int(bnd[0])) + ' ' + str(int(bnd[1])) + ' ' + str(
                                int(0.5 * (bnd[2] + bnd[0]))) + ' ' + str(int(bnd[3])) + ' %.2f' % (conf) + '\n'
                            file.write(label_bnd)
                            label_bnd = label[1] + ' ' + str(int(0.5 * (bnd[2] + bnd[0]))) + ' ' + str(
                                int(bnd[1])) + ' ' + str(int(bnd[2])) + ' ' + str(int(bnd[3])) + ' %.2f' % (conf) + '\n'
                            file.write(label_bnd)
...
if __name__ == '__main__':
    ...
    source = "F:/ZYY/chess/images/test3/check/labs/hist2/"
    out = "F:/ZYY/chess/images/test3/check/labs/1-2-out/"

    # source = "F:/ZYY/chess/images/test2/tmp/images/"
    # out = "F:/ZYY/chess/images/test2/tmp/out-1-2/"

    # parser.add_argument('--weights', nargs='+', type=str, default='runs/pt/1-2-val.pt', help='model.pt path(s)')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/pt/1-2-1000epoch.pt', help='model.pt path(s)')
